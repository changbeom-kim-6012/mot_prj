...
export default function OpinionDetailPage() {
  ...
  useEffect(() => {
    async function fetchDetail() {
      setLoading(true);
      try {
        const res = await axios.get(`http://121.140.143.9:8082/api/opinions/${articleId}`);
        ...
        // 첨부파일 목록도 불러오기
        const attRes = await axios.get('http://121.140.143.9:8082/api/attachments', {
                      ...
                      >
                        ...
                        파일보기
                         ...
                         onClick={() => {
                           ...
                           window.open(`http://121.140.143.9:8082/api/attachments/download/${encodedFileName}`, '_blank');
                         }}
