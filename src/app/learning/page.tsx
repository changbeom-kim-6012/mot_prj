...
export default function LearningPage() {
  ...
  const fetchLearningCategories = async () => {
    try {
      ...
      const basicResponse = await fetch('http://121.140.143.9:8082/api/codes');
      ...
      const response = await fetch('http://121.140.143.9:8082/api/codes/learning-details');
  ...
  const fetchSubjects = async (categoryId: number) => {
    try {
      ...
      const response = await fetch(`http://121.140.143.9:8082/api/subjects/category/${categoryId}`);
